...
RUN echo 'https://dl-cdn.alpinelinux.org/alpine/edge/main/' > /etc/apk/repositories \
    ...
    && apk add --no-cache wget net-tools openssh-client rsync ansible openjdk8 jq python3 python3-dev py3-pip build-base linux-headers libffi-dev libev-dev openssl-dev musl-dev zip unzip bash grep libarchive-tools \
    && apk update \
    && apk upgrade \
    ...
    && CASS_DRIVER_NO_EXTENSIONS=1 /venv/bin/pip install cassandra-driver==3.29.1 \
